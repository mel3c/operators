...
import (
	...
	daasv1 "rabbitmq-operator/pkg/apis/daas/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &daasv1.Rabbitmq{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *daasv1.Rabbitmq) *corev1.Pod {
