...
import (
	...
	daasv1 "kafka-operator/pkg/apis/daas/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &daasv1.Kafka{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *daasv1.Kafka) *corev1.Pod {
