...
import (
	...
	daasv1 "mongodb-operator/pkg/apis/daas/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &daasv1.Mongodb{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *daasv1.Mongodb) *corev1.Pod {
