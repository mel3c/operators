...
import (
	...
	daasv1 "rocketmq-operator/pkg/apis/daas/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &daasv1.Rocketmq{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *daasv1.Rocketmq) *corev1.Pod {
