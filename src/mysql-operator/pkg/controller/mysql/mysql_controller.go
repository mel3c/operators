...
import (
	...
	daasv1 "mysql-operator/pkg/apis/daas/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &daasv1.Mysql{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *daasv1.Mysql) *corev1.Pod {
